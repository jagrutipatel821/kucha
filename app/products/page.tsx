...
export default async function ProductsPage() {
  ...
  try {
    ...
    // Fetch active offer
    const offerRes = await fetch(`${process.env.NEXT_PUBLIC_BASE_URL}/api/offers`, {
      cache: 'no-store',
    });
  ...
  return (
    <div className="bg-white min-h-screen">
      {/* BLACK OFFER SECTION */}
      {offer && <OfferHeroSection offer={offer} />}

      {/* PRODUCTS */}
      <section id="products" className="max-w-5xl mx-auto px-6 py-30 text-center">
